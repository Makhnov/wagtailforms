    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('template_name', models.CharField(choices=[('widgets/forms/contact.html', 'Formulaire de contact'), ('widgets/forms/sorties.html', "Sorties de l'amicale"), ('widgets/forms/amicale.html', "Inscription à l'amicale"), ('widgets/forms/agents.html', 'Contactez la FAQ'), ('widgets/forms/administration.html', 'Contactez le secrétariat'), ('streamforms/form_block.html', 'Default Form Template')], max_length=255, verbose_name='Template')),
